...
public abstract record SoftwareArtifact(List<NamespaceMap>? namespaces,
    ...
    : Artifact(namespaces, imports, spdxId, name, summary, description, comment, creationInfo, verifiedUsing, externalReference, externalIdentifiers, originatedBy, suppliedBy, builtTime, releaseTime, validUntilTime, standard);
