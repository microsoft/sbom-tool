...
Actions
  ...
  Validate -options - Validate a build artifact using the manifest. Additional optio which verifies the signing certificate of the manifest.
...
Actions
  ...
  Validate -options - Validate a build artifact using the manifest. Additional option which verifies the signing certificate of the manifest.
