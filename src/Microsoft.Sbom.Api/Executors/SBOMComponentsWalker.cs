...
{
    public SBOMComponentsWalker(ILogger log, IRecorder recorder, ComponentDetectorCachedExecutor componentDetector, IConfiguration configuration, ISbomConfigProvider sbomConfigs, IFileSystemUtils fileSystemUtils)
        : base(log, recorder, componentDetector, configuration, sbomConfigs, fileSystemUtils)
    {
    }
